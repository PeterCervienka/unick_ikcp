						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="agreement">
													...
													<fo:block-container overflow="hidden">
														<fo:block text-align="center">
															<fo:inline font-family="Arial" font-size="16pt" font-weight="bold" text-align="center">
																<xsl:text>NÁVRH NA UZAVRETIE POISTNEJ ZMLUVY</xsl:text>
															</fo:inline>
														</fo:block>
													</fo:block-container>
												</fo:table-cell>
								...
								<fo:block font-size="0.15in" line-height="1.2" margin="0" padding="0" margin-right="0 + 100% - 100%" space-before="0" space-after="0">
									...
									<xsl:if test="hasAnyoneTechnicalHelp=&apos;true&apos;">
										<fo:inline-container>
											<fo:block>
												<xsl:text>&#x200B;</xsl:text>
											</fo:block>
												...
												<fo:table-row>
													<fo:table-cell number-columns-spanned="2" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>Pre prípad dojednania poistenia storna objednanej služby sa osobitne dojednáva, že poistné krytie v zmysle časti F, čl. 2 bod 1 a čl. 4 VPPIKCP/0114sa rozširuje takto:</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>okrem dôvodov uvedených v časti F, čl. 2 bod 1 VPPIKCP/0114 je poistnou udalosťou aj stornovanie objednanej služby z dôvodu zamietnutia žiadosti o pridelenie víz príslušným zastupiteľským úradom krajiny, do ktorej chce poistený vycestovať.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Maximálna výška poistného plnenia poisťovateľa je v tomto prípade 80% stornopoplatku uplatneného poskytovateľom služby, maximálne však 1.000 EUR / osoba.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>V tomto prípade je poistený, v súlade s časťou F, čl. 5, bod 3, písm. o) VPPIKCP/0114, povinný predložiť poisťovateľovi aj doklad preukazujúci zamietnutie žiadosti o pridelenie víz, potvrdený príslušným zastupiteľským úradom krajiny, ktorá mu túto žiadosť zamietla s uvedením dôvodu zamietnutia.</xsl:text>
																</fo:inline>
																<fo:block/>
															</fo:block>
														</fo:block-container>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>okrem dôvodov uvedených v časti F, čl. 2 bod 1 VPPIKCP/0114 je poistnou udalosťou aj stornovanie objednanej služby z dôvodu zmeškania odchodu hromadného dopravného prostriedku do zahraničia z dôvodu dopravnej nehody, ktorej priamym účastníkom bol poistený, pričom k dopravnej nehode došlo počas prepravy poisteného na miesto odchodu hromadného dopravného prostriedku, ktorým mal poistený cestovať do zahraničia.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Maximálna výška poistného plnenia poisťovateľa je v týchto prípadoch 50% stornopoplatku uplatneného poskytovateľom služby, maximálne však 500 EUR / osoba.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>V tomto prípade je poistený, v súlade s časťou F, čl. 5, bod 3, písm. o) VPPIKCP/0114, povinný predložiť poisťovateľovi aj záznam o dopravnej nehode vydaný príslušným Dopravným inšpektorátom.</xsl:text>
																</fo:inline>
																<fo:block/>
															</fo:block>
														</fo:block-container>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>okrem dôvodov uvedených v časti F, čl. 2 bod 1 VPPIKCP/0114 je poistnou udalosťou aj stornovanie objednanej služby z dôvodu zmeškania odchodu hromadného dopravného prostriedku do zahraničia z dôvodu technickej poruchy dopravného prostriedku, ktorým sa poistený prepravoval na miesto odchodu hromadného dopravného prostriedku, ktorým mal poistený cestovať do zahraničia.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Maximálna výška poistného plnenia poisťovateľa je v týchto prípadoch 50% stornopoplatku uplatneného poskytovateľom služby, maximálne však 500 EUR / osoba.</xsl:text>
																...
																<fo:block/>
																<fo:inline>
																	<xsl:text>V tomto prípade je poistený, v súlade s časťou F, čl. 5, bod 3, písm. o) VPPIKCP/0114, povinný predložiť poisťovateľovi aj doklad o vzniku a rozsahu technickej poruchy od príslušného dopravcu.</xsl:text>
																</fo:inline>
																<fo:block/>
															</fo:block>
														</fo:block-container>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>okrem dôvodov uvedených v časti F, čl. 2 bod 1 VPPIKCP/0114 je poistnou udalosťou aj stornovanie objednanej služby z dôvodu nepredvídaného zrušenia služobnej cesty z dôvodu zrušenia konferencie, sympózia, kongresu, výstavy alebo iného dlhodobo plánovaného pracovného stretnutia, na ktorom sa mal poistený zúčastniť, zo strany organizátora tejto konferencie alebo sympózia, kongresu, výstavy alebo iného dlhodobo plánovaného pracovného stretnutia.</xsl:text>
																</fo:inline>
																<fo:block/>
																<fo:inline>
																	<xsl:text>Maximálna výška poistného plnenia poisťovateľa je v tomto prípade 50% stornopoplatku uplatneného poskytovateľom služby, maximálne však 500 EUR / osoba.</xsl:text>
												...
												<fo:table-row>
													...
													<fo:table-cell number-columns-spanned="2" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline font-weight="bold">
																	<xsl:text>Poistenia predčasného návratu a nečerpaných služieb</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell number-columns-spanned="2" padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>Ak sa poistený vrátil z pobytu v zahraničí pred jeho ukončením z dôvodu:</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>jeho akútnej choroby, úrazu alebo náhleho zhoršenia zdravotného stavu, za podmienky, že ošetrujúci lekár v zahraničí odporučil návrat do vlasti alebo</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>že mu v čase po vycestovaní do zahraničia zomrela blízka osoba alebo</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>že počas doby trvania pobytu v zahraničí blízka osoba poisteného bola hospitalizovaná vo vlasti poisteného v dôsledku akútnej choroby alebo úrazu ohrozujúceho jej život, alebo</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>že počas doby trvania pobytu v zahraničí nastala živelná udalosť, ktorá spôsobila škodu na majetku poisteného v mieste jeho trvalého pobytu a vyžaduje si jeho návrat do miesta trvalého pobytu.</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-c
xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
												...
												<fo:table-row>
													...
													<fo:table-cell padding="0" display-align="center">
														<fo:block-container overflow="hidden">
															<fo:block text-align="left">
																<fo:inline>
																	<xsl:text>iné doklady jednoznačne preukazujúce vznik poistnej udalosti alebo iné doklady nevyhnutné pre likvidáciu poistnej udalosti, o ktoré poisťovateľ požiada.</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block-container>
													</fo:table-cell>
								...
								<fo:block font-size="0.15in" line-height="0.15in" text-align="justify" margin-right="100% - 100%" space-before="0" space-after="0" margin="0pt">
									...
									<fo:inline font-weight="bold">
										<xsl:text>Poistník poukázaním poistného na účet sprostredkovateľa poisťovateľa alebo zaplatením poistného poistníkom v hotovosti sprostredkovateľovi poistenia uzavrie poistnú zmluvu a potvrdzuje, že:</xsl:text>
									</fo:inline>
									<fo:inline-container>
										<fo:block>
											<xsl:text>&#x200B;</xsl:text>
									...
									<fo:list-block provisional-distance-between-starts="7mm" provisional-label-separation="2mm">
										<fo:list-item>
											...
											<fo:list-item-body start-indent="body-start()">
												<fo:block>
													<fo:inline font-weight="bold">
														<xsl:text>že mu boli oznámené a e-mailom doručené Všeobecné poistné podmienky individuálneho komplexného cestovného poistenia VPPIKCP/0114, a že s nimi súhlasí</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:list-item-body>
										</fo:list-item>
										<fo:list-item>
											...
											<fo:list-item-body start-indent="body-start()">
												<fo:block>
													<fo:inline font-weight="bold">
														<xsl:text>že mu bola oznámená a e-mailom doručená príloha k poistnej zmluve typu 701/702 s názvom „Rozsah poistenia a výška poistného krytia pre individuálne komplexné cestovné poistenie“, a že s ňou súhlasí</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:list-item-body>
										</fo:list-item>
										<fo:list-item>
											...
											<fo:list-item-body start-indent="body-start()">
												<fo:block>
													<fo:inline>
														<xsl:text>že mu bol oznámený a e-mailom doručený formulár o dôležitých zmluvných podmienkach uzatváranej poistnej zmluvy a informácie pre spotrebiteľa pred uzavretím poistnej zmluvy na diaľku v zmysle § 4 zákona c. 266/2005 Z. z. o ochrane spotrebiteľa pri finančných službách na diaľku</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:list-item-body>
										</fo:list-item>
								...
								<fo:block font-size="0.15in" line-height="0.15in" text-align="justify" margin-right="100% - 100%" space-before="0" space-after="0" margin="0pt">
									<fo:inline font-weight="bold">
										<xsl:text>Všeobecné poistné podmienky individuálneho komplexného cestovného poistenia VPPIKCP/0114 a prílohu k poistnej zmluve typu 701/702 s názvom „Rozsah poistenia a výška poistného krytia pre individuálne komplexné cestovné poistenie“ nájdete aj na www.union.sk a na 0850 111 211.</xsl:text>
									</fo:inline>
									<fo:inline>
										<xsl:text> Formulár o dôležitých zmluvných podmienkach uzatváranej poistnej zmluvy, informácie pre spotrebiteľa pri finančných službách na diaľku a ďalšie informácie o poisťovateľovi a poistení nájdete aj na www.union.sk.</xsl:text>
									</fo:inline>
									<fo:block/>
								</fo:block>
								<fo:block>
